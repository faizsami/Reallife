                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a href="#" onclick="event.preventDefault(); editcategory('{{ url('admin/edit-category/'.$category->id) }}', '{{$category->title}}', '{{$category->gst}}', '{{$category->hsn}}')" data-toggle="modal" data-target="#categorymodeledit" class="dropdown-item">
                                                            <i data-feather='edit'></i>
                                                            Edit
                                                        </a>

                                                        <a href="{{ url('/admin/delete-category/'.$category->id) }}" class="dropdown-item">
...
<div class="modal fade text-left" id="categorymodeledit" tabindex="-1" aria-labelledby="categorymodeledit" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <form method="post" action="{{ url('/admin/add-categories') }}" id="editcategoryform">
            @csrf
          <div class="modal-body">
            <label>Title: </label>
            <div class="form-group">
