                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{ url('admin/members') }}">All Members</a>
                                </li>
                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active" id="account" aria-labelledby="account-tab" role="tabpanel">
                                <form method="post" action="{{ url('/admin/member/'.$user->id.'/update') }}" enctype="multipart/form-data">
                                    @csrf
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            <form action="{{ url('admin/update-bank-details') }}" method="post">
                                                @csrf
                                ...
                                <div class="grid-margin stretch-card">
                                    <div class="card">
                                        <div class="card-body">
                                                                ...
                                                                <td>
                                                                    <div class="btn-group">
                                                                        ...
                                                                        <div class="dropdown-menu dropdown-menu-right">                                                                            
                                                                            <a href="{{ url('/admin/member/kyc/'.$kyc->id.'/1') }}" class="dropdown-item">
                                                                                <i data-feather='eye'></i>
                                                                                Apporve
                                                                            </a>

                                                                            <a href="{{ url('/admin/member/kyc/'.$kyc->id.'/2') }}" class="dropdown-item">
                                                                                <i data-feather='eye'></i>
                                                                                Decline
                                                                            </a>
                                                                        </div>
                                            ...
                                            <!-- form -->
                                            <form class="forms-sample mt-4" action="{{ url('/admin/member/update-kyc/'.$user->id) }}" method="post" enctype="multipart/form-data">
                                                @csrf
                                                <div class="row">
                                ...
                                <div class="grid-margin stretch-card">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <!-- form -->
                                            <form class="validate-form" method="post" action="{{ url('/admin/member/'.$user->id.'/password-change') }}">
                                                @csrf
                                                <div class="row">
