                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{ url('/admin/franchisee-packages') }}">Packages</a>
                                </li>
                                ...
                                <tbody>
                                    ...
                                    @foreach($packages as $package)
                                        <tr>
                                            ...
                                            <td>
                                                @if($package->status == 0)
                                                    <a href="{{ url('/admin/franchisee-package-status/'.$package->id.'/1') }}" class="text-danger" title="Inactive" data-toggle="tooltip"><i data-feather='eye-off'></i></a>
                                                @else
                                                    <a href="{{ url('/admin/franchisee-package-status/'.$package->id.'/0') }}" class="text-success" title="Active" data-toggle="tooltip"><i data-feather='eye'></i></a>
                                                @endif
                                            </td>
                                        </tr>
                                        @php($i++)
...
<div class="modal fade text-left" id="addpackagemodal" tabindex="-1" aria-labelledby="addpackagemodal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <form method="post" action="{{ url('/admin/add-franchisee-package') }}">
            @csrf            
