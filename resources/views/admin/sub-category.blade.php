                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a href="#" onclick="event.preventDefault(); editcategory('{{ url('/admin/edit-sub-category/'.$category->id) }}', '{{$category->category->title}}', '{{$category->category->id}}', '{{$category->title}}')" data-toggle="modal" data-target="#categorymodeledit" class="dropdown-item">
                                                            <i data-feather='edit'></i>
                                                            Edit
                                                        </a>

                                                        <a href="{{ url('/admin/delete-sub-category/'.$category->id) }}" class="dropdown-item">
