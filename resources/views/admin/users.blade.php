                                                        ...
                                                        <td>
                                                            <div class="btn-group">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    <a href="{{ url('/admin/member/'.$user->id.'/view') }}" class="dropdown-item">
                                                                        <i data-feather='edit'></i>
                                                                        View
                                                                    </a>

                                                                    <a href="{{ url('/admin/tree?id='.$user->user_id) }}" class="dropdown-item">
                                                                        <i data-feather='users'></i>
                                                                        Team View
                                                                    </a>

                                                                    <a href="{{ url('/admin/directs?id='.$user->user_id) }}" class="dropdown-item">
                                                                        <i data-feather='git-pull-request'></i>
                                                                        Direct View
                                                                    </a>

                                                                    @if($user->is_block == 0)
                                                                        <a href="{{ url('/admin/member/status/'.$user->id.'/1') }}" class="dropdown-item text-danger">
                                                                            <i data-feather='eye-off'></i>
                                                                            Block
                                                                        </a>
                                                                    @else
                                                                        <a href="{{ url('/admin/member/status/'.$user->id.'/0') }}" class="dropdown-item text-success">
