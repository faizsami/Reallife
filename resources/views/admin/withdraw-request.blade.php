                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{ url('/admin/withdraw-requests') }}">Requests</a>
                                </li>
                                <li class="breadcrumb-item active">Withdraw Requests
                                </li>
                            </ol>
                        </div>
                    </div>
                                        ...
                                        <tbody>
                                            ...
                                            @foreach($requests as $request)
                                                <tr>
                                                    ...
                                                    <td> @php($tdss = App\Models\AdminSetting::get()->first()->tds/100 + App\Models\AdminSetting::get()->first()->admin_charge/100)
                                                        @php($tds =$request->amount-( $request->amount * $tdss))
                                                        {{number_format($tds, 2)}}</td>
                                                        ...
                                                        @if($request->status != 1)
                                                            <div class="btn-group">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    <a href="{{ url('/admin/withdraw-request/accept/'.$request->id) }}"  class="dropdown-item" >
                                                                        <i data-feather='check-square'></i>
                                                                        Accept
                                                                    </a>                                                                

                                                                    <a href="{{ url('/admin/withdraw-request/decline/'.$request->id) }}" class="dropdown-item">
