...
<head>
    ...
    <title>Forgot Password - Regal Life India</title>
                ...
                <div class="auth-wrapper auth-v2">
                    <div class="auth-inner row m-0">
                        ...
                        <div class="d-none d-lg-flex col-lg-8 align-items-center p-5">
                            <div class="w-100 d-lg-flex align-items-center justify-content-center px-5"><img class="img-fluid" src="{{ asset('assets/images/pages/forgot-password-v2.svg') }}" alt="Forgot password V2" /></div>
                        </div>
                        <!-- /Left Text-->
                        <!-- Forgot password-->
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                ...
                                @if (session('status'))
                                        <p class="invalid-feedback text-success" style="display:block!important;" role="alert">
                                ...
                                <form class="mt-2" method="POST" action="{{ route('password.email') }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="email" class="form-control" type="text" placeholder="neeraj@example.com"autofocus="" :value="old('email')" tabindex="1" />
                                        @if($errors->has('email'))
