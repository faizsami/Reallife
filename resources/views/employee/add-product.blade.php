    ...
    <div class="content-wrapper">
        ...
        <div class="content-body">
            <div class="col-md-12 stretch-card">
                <div class="card">
                    <div class="card-body">
                            <form action="{{ url('/employee/add-product') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="sprice" maxlength="10" onkeypress="return isNumberKey(event)" placeholder="Sell Price">
                                                    @if($errors->has('price'))
                                                        <p class="invalid-feedback text-danger" style="display:block!important;" role="alert">
                                                            <strong>{{ $errors->first('price') }}</strong>
                                                        </p>
