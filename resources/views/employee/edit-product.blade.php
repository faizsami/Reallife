    ...
    <div class="content-wrapper">
        ...
        <div class="content-body">
            <div class="col-md-12 stretch-card">
                <div class="card">
                    <div class="card-body">
                            <form action="{{ url('/employee/edit-product/'.$product->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf

                                <div class="row">
                                    <div class="col-lg-2 col-md-2 col-12">
                                        <img class="img-thumbnail" height="250px" width="200px" src="{{ asset('uploads/products/'.$product->image) }}" id="product_img"/>
                                        ...
                                        <div class="row">
                                                    ...
                                                    <div class="col-10">
                                                        <div class="form-group">
                                                            ...
                                                            <Select name="sub_category_id" class="form-control" id="sub_category_id">
                                                                <option class="custom_option" value="{{$product->sub_category_id}}">{{$product->sub_category->title}}</option>                                      
                                                            </Select>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input value="{{$product->product_code}}" type="text" onkeypress="return isAlphaKeysWithNumeric(event)" name="product_code" class="form-control" placeholder="Product Code">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input value="{{$product->name}}" type="text" id="nameinput" name="name" onkeypress="return isAlphaKeys(event)" onkeyup="clearmultispace($(this).val(), $(this).attr('id'))" class="form-control" placeholder="Product Name">
                                                    @if($errors->has('name'))
                                                        <p class="invalid-feedback text-danger" style="display:block!important;" role="alert">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control"  value="{{$product->weight}}" name="weight" maxlength="4" onkeypress="return isNumberKey(event)" placeholder="Product Weight (gram)">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input value="{{$product->price}}" type="text" class="form-control" name="price" maxlength="10" onkeypress="return isNumberKey(event)" placeholder="Product Price">
                                                    @if($errors->has('price'))
                                                        <p class="invalid-feedback text-danger" style="display:block!important;" role="alert">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input value="{{$product->sell_price}}" type="text" class="form-control" name="sprice" maxlength="10" onkeypress="return isNumberKey(event)" placeholder="Sell Price">
                                                    @if($errors->has('price'))
                                                        <p class="invalid-feedback text-danger" style="display:block!important;" role="alert">
                                                            <strong>{{ $errors->first('price') }}</strong>
                                                        </p>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input value="{{$product->stock}}" type="number" name="stock" onkeypress="return isNumberKey(event)" class="form-control" placeholder="Add Stock">
                                                    @if($errors->has('stock'))
                                                        <p class="invalid-feedback text-danger" style="display:block!important;" role="alert">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input value="{{$product->bv}}" type="number" name="bv" onkeypress="return isNumberKey(event)" class="form-control" autocomplete="off" placeholder="Product BV">
                                                    @if($errors->has('bv'))
                                                        <p class="invalid-feedback text-danger" style="display:block!important;" role="alert">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="description" class="form-control" autocomplete="off" rows="1" placeholder="Description">{{$product->description}}</textarea>
...
<div class="modal fade text-left" id="categorymodel" tabindex="-1" aria-labelledby="categorymodel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <form method="post" action="{{ url('/employee/add-categories') }}">
            @csrf
          <div class="modal-body">
            <label>Title: </label>
            <div class="form-group">
                <input type="text" id="cateName_id" onkeyup="clearmultispace($(this).val(), $(this).attr('id'))" onkeypress="return isAlphaKeysWithNumeric(event)" class="form-control" name="title" placeholder="Category Title" autocomplete="off" required>
                @if($errors->has('title'))
                    <p class="invalid-feedback text-danger" style="display:block!important;" role="alert">
            ...
            <label>GST(%): </label>
            <div class="form-group">
                <input type="text" onkeyup="checkforgst($(this).val())" onkeypress="return isNumberKey(event)" maxlength="2" okey class="form-control" name="gst" autocomplete="off" placeholder="GST">
                @if($errors->has('gst'))
                    <p class="invalid-feedback text-danger" style="display:block!important;" role="alert">
          ...
          <div class="modal-footer">
            <button id="sub_btn_cate" type="submit" class="btn btn-primary waves-effect waves-float waves-light" disabled>Add Category</button>
          </div>
        </form>
      </div>
    </div>
