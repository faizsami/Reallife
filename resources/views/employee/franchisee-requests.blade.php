                                                        ...
                                                        @if($req->status != 1)
                                                            <div class="btn-group">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    <a href="#" class="dropdown-item" data-toggle="modal" data-target="#sendMoneyModel" onclick="event.preventDefault(); callacceptmodal('{{ url('employee/accept-franchisee-request/'.$req->id) }}', '{{$req->transaction_id}}', '{{$req->transaction_date}}', '{{$req->franchisee_package->extra}} % extra ( {{$req->franchisee_package->name}} - ₹{{number_format($req->franchisee_package->amount, 2)}} )')">
                                                                        <i data-feather='check-square'></i>
                                                                        Accept
                                                                    </a>                                                                

                                                                    <a href="{{ url('/employee/decline-franchisee-request/'.$req->id) }}" class="dropdown-item">
