                ...
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ url('/employee/fund-requests') }}">Requests</a>
                                </li>
                                                        ...
                                                        @if($fundrequest->status != 1)
                                                            <div class="btn-group">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    <a href="#" class="dropdown-item" data-toggle="modal" data-target="#sendMoneyModel" onclick="event.preventDefault(); callacceptmodal('{{ url('employee/accept-fund-request/'.$fundrequest->id) }}', '{{$fundrequest->transaction_id}}', '{{$fundrequest->transaction_date}}', '{{$fundrequest->amount}}')">
                                                                        <i data-feather='check-square'></i>
                                                                        Accept
                                                                    </a>                                                                

                                                                    <a href="{{ url('/employee/decline-fund-request/'.$fundrequest->id) }}" class="dropdown-item">
