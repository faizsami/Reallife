                ...
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ url('/employee/products') }}">Home</a>
                                </li>
                    ...
                    <div class="col-12">
                        <div class="card p-1">
                            <div class="card-header">
                                ...
                                <a href="{{ url('/employee/add-product') }}" class="btn btn-primary float-right"><i data-feather='plus'></i> Add Product</a>
                            </div>
                            <div class="card-body">
                                                    ...
                                                    <td>
                                                        <img src="{{ asset('uploads/products/'.$product->image) }}" class="rounded-circle" width="50px"/>
                                                            ...
                                                            <td>
                                                                @if($product->status == 0)
                                                                    <label class="switch">
                                                                        <input type="checkbox" checked onchange="window.location = '{{ url('/employee/product-status/'.$product->id.'/1') }}'">
                                                                        <span class="slider round"></span>
                                                                    </label>
                                                                @else
                                                                    <label class="switch">
                                                                        <input type="checkbox" onchange="window.location = '{{ url('/employee/product-status/'.$product->id.'/0') }}'">
                                                                        <span class="slider round"></span>
                                                                    </label>
                                                                @endif
                                                            </td>
                                                            <td>
                                                                <div class="btn-group">
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-right">
                                                                        <a href="{{ url('/employee/edit-product/'.$product->id) }}" class="dropdown-item">
                                                                        ...
                                                                        <a href="{{ url('/employee/delete-product/'.$product->id) }}" class="dropdown-item">
...
<div class="modal fade text-left" id="addstockmodel" tabindex="-1" aria-labelledby="addstockmodel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <form method="post" action="{{ url('/employee/add-product-stock') }}">
            @csrf
