                ...
                <div class="misc-wrapper"><a class="brand-logo" href="javascript:void(0);">                        
                    ...
                    <div class="misc-inner p-2 p-sm-3">
                        <div class="w-100 text-center">
                            ...
                            </p><a class="btn btn-primary mb-1 btn-sm-block" href="{{ url('/') }}">Back to home</a><img class="img-fluid" src="{{ asset('assets/images/pages/not-authorized.svg') }}" alt="Not authorized page" />
                        </div>
                    </div>
                </div>
                <!-- / Not authorized-->
