            ...
            <ul class="nav navbar-nav align-items-center ml-auto">                
                    ...
                    <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                        <li class="dropdown-menu-header">
                            <div class="dropdown-header d-flex">
                                ...
                                <div class="badge badge-pill badge-light-primary">{{$total_notification}} Notifications</div>
                            </div>
                        </li>
                ...
                <li class="nav-item dropdown dropdown-user">
                    <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="user-nav d-sm-flex d-none"><span class="user-name font-weight-bolder">{{ Auth::user()->user_name }}</span><span class="user-status"></span></div><span class="avatar"><img class="round" src="{{ asset('uploads/profiles/profile.png') }}" alt="avatar" height="40" width="40"><span class="avatar-status-online"></span></span>
                    </a>
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown-user">
						<a class="dropdown-item" href="{{ url('/employee/change-password') }}">
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item mr-auto"><a class="navbar-brand" href="{{ url('/employee/dashboard') }}"><span class="brand-logo">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
				@if(Auth::user()->user_role == 'employee')                
                    <li class="{{ $active == 'kyc' ? 'active' : ''}} nav-item">
                        <a class="d-flex align-items-center" href="{{ url('/employee/pending-kyc') }}">
                            <i data-feather='user-check'></i>
                            <span class="menu-title text-truncate" data-i18n="Chat">Pending KYC's</span>
                        </a>
				    </li>
                @endif

                @if(Auth::user()->user_role == 'roletwo')
                    <li class="{{ $active == 'users' ? 'active' : ''}} nav-item">
                        <a class="d-flex align-items-center" href="{{ url('/employee/users') }}">
                            <i data-feather='users'></i>
                            <span class="menu-title text-truncate" data-i18n="Chat">Members</span>
                        </a>
                    </li>
                @endif

                @if(Auth::user()->user_role == 'rolethree')
                    <li class="{{ $active == 'users' ? 'active' : ''}} nav-item">
                        <a class="d-flex align-items-center" href="{{ url('/employee/add-product') }}">
                            <i data-feather='shopping-bag'></i>
                            <span class="menu-title text-truncate" data-i18n="Chat">Add Product</span>
                        </a>
                    </li>

                    <li class="{{ $active == 'users' ? 'active' : ''}} nav-item">
                        <a class="d-flex align-items-center" href="{{ url('/employee/categories') }}">
                            <i data-feather='feather'></i>
                            <span class="menu-title text-truncate" data-i18n="Chat">Categories</span>
                        </a>
                    </li>

                    <li class="{{ $active == 'users' ? 'active' : ''}} nav-item">
                        <a class="d-flex align-items-center" href="{{ url('/employee/sub-categories') }}">
                            <i data-feather='git-pull-request'></i>
                            <span class="menu-title text-truncate" data-i18n="Chat">Sub-categories</span>
                        </a>
                    </li>

                    <li class="{{ $active == 'products' ? 'active' : ''}} nav-item">
                        <a class="d-flex align-items-center" href="{{ url('/employee/products') }}">
                            <i data-feather='shopping-cart'></i>
                            <span class="menu-title text-truncate" data-i18n="Chat">Product</span>
                        </a>
                    </li>
                @endif

                @if(Auth::user()->user_role == 'rolefour')
                    <li class="{{ $active == 'fund-request' ? 'active' : ''}} nav-item">
                        <a class="d-flex align-items-center" href="{{ url('/employee/fund-request') }}">
                            <i data-feather='bar-chart-2'></i>
                            <span class="menu-title text-truncate" data-i18n="Chat">Fund-Requests</span>
                        </a>
                    </li>

                    <li class="{{ $active == 'withdrawal-request' ? 'active' : ''}} nav-item">
                        <a class="d-flex align-items-center" href="{{ url('/employee/withdrawal-request') }}">
                            <i data-feather='bar-chart'></i>
                            <span class="menu-title text-truncate" data-i18n="Chat">Withdrawal-Requests</span>
                        </a>
                    </li>

                @endif

                @if(Auth::user()->user_role == 'rolefive')
                    <li class="{{ $active == 'fund-request' ? 'active' : ''}} nav-item">
                        <a class="d-flex align-items-center" href="{{ url('/employee/franchisee-package') }}">
                    ...
                    <li class="{{ $active == 'fund-request' ? 'active' : ''}} nav-item">
                        <a class="d-flex align-items-center" href="{{ url('/employee/franchisee/orders') }}">
                            <i data-feather='check-circle'></i>
                            <span class="menu-title text-truncate" data-i18n="Chat">Orders</span>
                        </a>
                    </li>

                    <li class="{{ $active == 'fund-request' ? 'active' : ''}} nav-item">
                        <a class="d-flex align-items-center" href="{{ url('/employee/franchisee-request') }}">
                            <i data-feather='crosshair'></i>
                            <span class="menu-title text-truncate" data-i18n="Chat">Requests</span>
                        </a>
                    </li>
                @endif
