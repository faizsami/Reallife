    ...
    <nav class="header-navbar navbar navbar-expand-lg align-items-center floating-nav navbar-light navbar-shadow">
        <div class="navbar-container d-flex content">
            <div class="bookmark-wrapper d-flex align-items-center">
                ...
                {{-- Marquee tag here
                <marquee><div class="badge .badge-glow badge-primary">This is dummy information for admin. This is dummy information for admin. This is dummy information for admin. </div></marquee>            --}}
            </div>
  
            <ul class="nav navbar-nav align-items-center ml-auto">
                <li class="nav-item d-lg-block"><a class="nav-link" href="{{ url('/admin/change-theme-dark') }}"><i class="ficon" data-feather="{{Auth::user()->theme->setting == 1 ? 'sun' : 'moon' }}"></i></a></li>                                
                ...
                <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="user-nav d-sm-flex d-none"><span class="user-name font-weight-bolder">{{ Auth::user()->user_name }}</span><span class="user-status">Admin</span></div><span class="avatar"><img class="round" src="{{ asset('uploads/profiles/'.Auth::user()->personal->profile_image) }}" alt="avatar" height="40" width="40"><span class="avatar-status-online"></span></span>
                    </a>
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown-user">
                        ...
                        <a class="dropdown-item" href="{{ url('/admin/wallet') }}">
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class="{{ $active[0] == 'profile' ? 'has-sub sidebar-group-active menu-collapsed-open' : ''}} nav-item">
                    ...
                    <ul class="menu-content">
                        ...
                        <li class="{{ $active[1] == 'edit' ? 'active' : ''}}">
                            <a class="d-flex align-items-center" href="{{ url('/admin/edit-profile') }}">
                                <i data-feather="circle"></i>
                                <span class="menu-item" data-i18n="Edit">Edit Details</span>
                            </a>
                        </li>

                        <li class="{{ $active[1] == 'news' ? 'active' : ''}}">
                            <a class="d-flex align-items-center" href="{{ url('/admin/news') }}">
                                <i data-feather="circle"></i>
                ...
                <!-- Members -->                
                <li class="{{ $active[0] == 'members' ? 'has-sub sidebar-group-active menu-collapsed-open' : ''}} nav-item">
					<a class="d-flex align-items-center" href="#">
						<i data-feather='users'></i>
						<span class="menu-title text-truncate" data-i18n="Shopping">Members</span>
					</a>
                    <ul class="menu-content">
                        <li class="{{ $active[1] == 'members' ? 'active' : ''}}">
                            <a class="d-flex align-items-center" href="{{ url('/admin/members') }}">
                                <i data-feather="circle"></i>
                                <span class="menu-item" data-i18n="Edit">All Members</span>
                            </a>
                        </li>

                        <li class="{{ $active[1] == 'kycs' ? 'active' : ''}}">
                            <a class="d-flex align-items-center" href="{{ url('/admin/pending-kyc') }}">
                                <i data-feather="circle"></i>
                                <span class="menu-item" data-i18n="Edit">Pending KYC's</span>
                            </a>
                        </li>

                        <li class="{{ $active[1] == 'registration' ? 'active' : ''}}">
							<a class="d-flex align-items-center" href="{{ url('/admin/registration') }}">
								<i data-feather="circle"></i>
				...
				<li class="{{ $active[0] == 'shopping' ? 'has-sub sidebar-group-active menu-collapsed-open' : ''}} nav-item">
                    ...
                    <ul class="menu-content">
                        ...
                        <li class="{{ $active[1] == 'add-product' ? 'active' : ''}}">
                            <a class="d-flex align-items-center" href="{{ url('/admin/add-product') }}">
                                <i data-feather="circle"></i>
                                <span class="menu-item" data-i18n="Edit">Add Products</span>
                            </a>
                        </li>
                        
                        <li class="{{ $active[1] == 'category' ? 'active' : ''}}">
                        ...
                        <li class="{{ $active[1] == 'subcategory' ? 'active' : ''}}">
				...
				<li class="{{ $active[0] == 'teamview' ? 'has-sub sidebar-group-active menu-collapsed-open' : ''}} nav-item">
                    ...
                    <ul class="menu-content">
                        <li class="{{ $active[1] == 'treeview' ? 'active' : ''}}">
                            <a class="d-flex align-items-center" href="{{ url('/admin/tree') }}">
                                <i data-feather="circle"></i>
                                <span class="menu-item" data-i18n="List">My TreeView</span>
                            </a>
                        </li>
                        <li class="{{ $active[1] == 'directs' ? 'active' : ''}}">
                            <a class="d-flex align-items-center" href="{{ url('/admin/directs') }}">
                                <i data-feather="circle"></i>
                ...
                <!-- Finance -->
                <li class="{{ $active[0] == 'finance' ? 'has-sub sidebar-group-active menu-collapsed-open' : ''}} nav-item">
					<a class="d-flex align-items-center" href="#">
                    ...
                    <ul class="menu-content">
                        <li class="{{ $active[1] == 'wallet' ? 'active' : ''}}">
                            <a class="d-flex align-items-center" href="{{ url('/admin/wallet') }}">
                                <i data-feather="circle"></i>
                                <span class="menu-item" data-i18n="List">Wallet</span>
                            </a>
                        </li>
                        <li class="{{ $active[1] == 'fund-requests' ? 'active' : ''}}">
                            <a class="d-flex align-items-center" href="{{ url('/admin/fund-requests') }}">
                                <i data-feather="circle"></i>
                                <span class="menu-item" data-i18n="View">Fund Requests</span>
                            </a>
                        </li>

                        <li class="{{ $active[1] == 'withdraw-requests' ? 'active' : ''}}">
                            <a class="d-flex align-items-center" href="{{ url('/admin/withdraw-requests') }}">
                                <i data-feather="circle"></i>
                ...
                <li class="{{ $active[0] == 'franchisee' ? 'has-sub sidebar-group-active menu-collapsed-open' : ''}} nav-item">
                    ...
                    <ul class="menu-content">
                        <li class="{{ $active[1] == 'package' ? 'active' : ''}}">
                            <a class="d-flex align-items-center" href="{{ url('/admin/franchisee-package') }}">
                                <i data-feather="circle"></i>
                                <span class="menu-item" data-i18n="List">Package</span>
                            </a>
                        </li>
                        <li class="{{ $active[1] == 'request' ? 'active' : ''}}">
                            <a class="d-flex align-items-center" href="{{ url('/admin/franchisee-request') }}">
                                <i data-feather="circle"></i>
                                <span class="menu-item" data-i18n="View">Requests</span>
                            </a>
                        </li>
                        <li class="{{ $active[1] == 'franchisee-orders' ? 'active' : ''}}">
                            <a class="d-flex align-items-center" href="{{ url('/admin/franchisee/orders') }}">
                                <i data-feather="circle"></i>
                                <span class="menu-item" data-i18n="View">Orders</span>
                            </a>
                        </li>

                        {{-- <li class="{{ $active[1] == 'franchisers' ? 'active' : ''}}">
                            <a class="d-flex align-items-center" href="{{ url('/admin/franchisers') }}">
                                <i data-feather="circle"></i>
                                <span class="menu-item" data-i18n="View">Franchisers</span>
                            </a>
                        </li> --}}
                    </ul>
                </li>

                <li class="{{ $active == 'reports' ? 'has-sub sidebar-group-active menu-collapsed-open' : ''}} nav-item">
					<a class="d-flex align-items-center" href="#">
                    ...
                    <ul class="menu-content">
                        <li class="{{ $active == 'bv_report' ? 'active' : ''}}">
                            <a class="d-flex align-items-center" href="{{ url('/admin/bv-report') }}">
                                <i data-feather="circle"></i>
                                <span class="menu-item" data-i18n="List">B.V Report</span>
                            </a>
                        </li>
                        <li class="{{ $active == 'my_gen_bonus_report' ? 'active' : ''}}">
                            <a class="d-flex align-items-center" href="{{ url('/admin/genbonus') }}">
                                <i data-feather="circle"></i>
                                <span class="menu-item" data-i18n="List">My Gen Per Bonus</span>
                            </a>
                        </li>
                        <li class="{{ $active == 'user_report' ? 'active' : ''}}">
                            <a class="d-flex align-items-center" href="{{ url('/admin/user-report') }}">
                                <i data-feather="circle"></i>
                                <span class="menu-item" data-i18n="List">User Report</span>
                            </a>
                        </li>

                        <li class="{{ $active == 'team_report_gen' ? 'active' : ''}}">
                            <a class="d-flex align-items-center" href="{{ url('/admin/team-report-gen') }}">
                                <i data-feather="circle"></i>
                                <span class="menu-item" data-i18n="List">Team Report(GEN)</span>
                            </a>
                        </li>

                        <li class="{{ $active == 'team_report_org' ? 'active' : ''}}">
                            <a class="d-flex align-items-center" href="{{ url('/admin/team-report-org') }}">
                                <i data-feather="circle"></i>
                                <span class="menu-item" data-i18n="List">Team Report(ORG)</span>
                            </a>
                        </li>

                        <li class="{{ $active == 'online_sell_report' ? 'active' : ''}}">
                            <a class="d-flex align-items-center" href="{{ url('/admin/online-sell-report') }}">
                                <i data-feather="circle"></i>
                                <span class="menu-item" data-i18n="List">Online Sell Report</span>
                            </a>
                        </li>

                        <li class="{{ $active == 'business_centre_sell_report' ? 'active' : ''}}">
                            <a class="d-flex align-items-center" href="{{ url('/admin/business-centre-sell-report') }}">
                                <i data-feather="circle"></i>
                                <span class="menu-item" data-i18n="List">Centre Sell Report</span>
                            </a>
                        </li>

                        <li class="{{ $active == 'total_sell_report' ? 'active' : ''}}">
                            <a class="d-flex align-items-center" href="{{ url('/admin/total-sell-report') }}">
                                <i data-feather="circle"></i>
                                <span class="menu-item" data-i18n="List">Total Sell Report</span>
                            </a>
                        </li>
                        
                        <li class="{{ $active == 'gst_report' ? 'active' : ''}}">
                            <a class="d-flex align-items-center" href="{{ url('/admin/gst-report') }}">
                                <i data-feather="circle"></i>
                                <span class="menu-item" data-i18n="List">GST Report</span>
                            </a>
                        </li>

                        <li class="{{ $active == 'tds_report' ? 'active' : ''}}">
                            <a class="d-flex align-items-center" href="{{ url('/admin/tds-report') }}">
                                <i data-feather="circle"></i>
                ...
                <li class="{{ $active[0] == 'closing' ? 'has-sub sidebar-group-active menu-collapsed-open' : ''}} nav-item">
					<a class="d-flex align-items-center" href="#">
						<i data-feather='check-circle'></i>
						<span class="menu-title text-truncate" data-i18n="TeamView">Closing</span>
					</a>
                    <ul class="menu-content">
                        <li class="{{ $active[1] == 'view' ? 'active' : ''}}">
                            <a class="d-flex align-items-center" href="{{ url('/admin/view-closing') }}">
                                <i data-feather="circle"></i>
                ...
                <li class="{{ $active == 'download' ? 'active' : ''}} nav-item">
					<a class="d-flex align-items-center" href="{{ url('/admin/backup') }}">
