                    ...
                    <div class="row align-items-center">	
                        <div class="col-xl-7 col-md-6 animation" data-animation="bounceInUp" data-animation-delay="0.3s">
                            <div class="about_img fancy_border text-center">
                                <img data-parallax='{"y": 30, "smoothness": 20}' src="{{ asset('landing/images/about_img.png') }}" alt="about_img" />
                            </div>
                        </div>
                        <div class="col-xl-5 col-md-6 order-md-first animation" data-animation="bounceInUp" data-animation-delay="0.4s">
                            ...
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit sed do eiusmotempor incididunt labore et dolore magna aliqua enim minim veniam</p>
                            <p>If you are going to use a passage of Lorem Ipsum anything embarrassing hidden in the middle of text.</p>
                            <ul class="list_none list_item about_counter box_shadow4">
                               ...
                               <li>
                                ...
                                <li>
                                    <div class="counter_content">
                                        <h3><span class="counter">152</span>+</h3>
                                        <p>Our Brands</p>
                                    </div>
                                </li>
                            </ul>
                            ...
                            <a href="#" class="btn btn-default rounded-0 mt-3">Learn More</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="overlap_shape">
        <div class="ol_shape25">
            <div class="animation" data-animation="bounceInDown" data-animation-delay="0.5s">
                <img data-parallax='{"y": -30, "smoothness": 20}' src="{{ asset('landing/images/shape44.png') }}" alt="shape44"/>
            </div>
        </div>
        <div class="ol_shape26">
            <div class="animation" data-animation="zoomIn" data-animation-delay="0.5s">
                <img data-parallax='{"y": 30, "smoothness": 20}' src="{{ asset('landing/images/shape45.png') }}" alt="shape45"/>
            </div>
        </div>
        <div class="ol_shape27">
            <div class="animation" data-animation="zoomIn" data-animation-delay="0.5s">
                <img data-parallax='{"y": 30, "smoothness": 20}' src="{{ asset('landing/images/shape46.png') }}" alt="shape46"/>
            </div>
        </div>
        <div class="ol_shape28">
            <div class="animation" data-animation="bounceInUp" data-animation-delay="0.5s">
                <img data-parallax='{"y": 30, "smoothness": 20}' src="{{ asset('landing/images/shape47.png') }}" alt="shape47"/>
            </div>
        </div>
        <div class="ol_shape29">
            <div class="animation" data-animation="slideInRight" data-animation-delay="0.5s">
                <img data-parallax='{"y": 30, "smoothness": 20}' src="{{ asset('landing/images/shape48.png') }}" alt="shape48"/>
            </div>
        </div>
        <div class="ol_shape30">
            <div class="animation" data-animation="slideInRight" data-animation-delay="0.5s">
                <img data-parallax='{"y": 30, "smoothness": 20}' src="{{ asset('landing/images/shape49.png') }}" alt="shape49"/>
            </div>
        </div>
        <div class="ol_shape31">
            <div class="animation" data-animation="slideInRight" data-animation-delay="0.5s">
                <img data-parallax='{"y": 30, "smoothness": 20}' src="{{ asset('landing/images/shape50.png') }}" alt="shape50"/>
            </div>
        </div>
    </div>
</section>
    	...
    	<div class="row justify-content-center">
        	<div class="col-xl-6 col-md-8 text-center">
                <div class="heading_s2 text-center animation" data-animation="fadeInUp" data-animation-delay="0.02s">
                	<span class="sub_heading">See Our Features</span>
                    <h2>Why Choose Us</h2>
                </div>
                <p class="animation" data-animation="fadeInUp" data-animation-delay="0.03s"> Lorem ipsum dolor sit amet, consectetur blandit magna adipiscing elit ncididunt labore et dolore magna aliqua enim. </p>
            </div>
        </div>
        <div class="row">
        	<div class="col-xl-3 col-md-6">
            	<div class="icon_box icon_box_style3 box_shadow4 bg-white animation" data-animation="fadeInUp" data-animation-delay="0.04s">
                    ...
                    <div class="intro_desc">
                        ...
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit sed eiusmod labore dolore magna.</p>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-md-6">
	...
	<div class="container">
    	<div class="row justify-content-center">
        	<div class="col-xl-6 col-md-8 text-center">
            	<div class="heading_s2 text-center">
                	<span class="sub_heading">Meet Our Team</span>
                	<h2>Our Farmers</h2>
                </div>
                <p class="animation" data-animation="fadeInUp" data-animation-delay="0.03s"> Lorem ipsum dolor sit amet, consectetur blandit magna adipiscing elit ncididunt labore et dolore magna aliqua enim. </p>
        ...
        <div class="row animation" data-animation="fadeInUp" data-animation-delay="0.4s">
        	<div class="col-lg-3 col-sm-6">
            	<div class="team_box">
                	<div class="team_img">
                    	<img src="{{ asset('landing/images/team1.jpg') }}" alt="team1">
                    </div>
                    <div class="team_info">
            ...
            <div class="col-lg-3 col-sm-6">
            	<div class="team_box">
                	<div class="team_img">
                    	<img src="{{ asset('landing/images/team2.jpg') }}" alt="team2">
                    </div>
                    <div class="team_info">
                        <div class="team_title">
                            <h5>Grace Wong</h5>
            ...
            <div class="col-lg-3 col-sm-6">
            	<div class="team_box">
                	<div class="team_img">
                    	<img src="{{ asset('landing/images/team3.jpg') }}" alt="team3">
            ...
            <div class="col-lg-3 col-sm-6">
            	<div class="team_box">
                	<div class="team_img">
                    	<img src="{{ asset('landing/images/team4.jpg') }}" alt="team4">
                    </div>
                    <div class="team_info">
                        <div class="team_title">
                            <h5>james white</h5>
        	...
        	<div class="col-12 animation" data-animation="fadeInUp" data-animation-delay="0.04s">
            	<div class="testimonial_slider testimonial_style1 carousel_slide3 owl-carousel owl-theme" data-margin="30" data-loop="true" data-autoplay="true" data-dots="false">
                    <div class="testimonial_box">
                        ...
                        <div class="testi_meta">
                        	<div class="testimonial_img">
                                <img src="{{ asset('landing/images/client_img1.jpg') }}" alt="client">
                            </div>
                    ...
                    <div class="testimonial_box">
                        ...
                        <div class="testi_meta">
                        	<div class="testimonial_img">
                                <img src="{{ asset('landing/images/client_img2.jpg') }}" alt="client">
                            </div>
                        	<div class="testi_user">
                            	<h5>John Mark</h5>
                                <span>Web Designer</span>
                    ...
                    <div class="testimonial_box">
                        ...
                        <div class="testi_meta">
                        	<div class="testimonial_img">
                                <img src="{{ asset('landing/images/client_img3.jpg') }}" alt="client">
                            </div>
                        	<div class="testi_user">
    ...
    <div class="overlap_shape">
        <div class="ol_shape17">
            <div class="animation" data-animation="fadeInLeft" data-animation-delay="0.5s">
                <img data-parallax='{"y": 20, "smoothness": 20}' src="{{ asset('landing/images/testimonial_bg_img1.jpg') }}" alt="testimonial_bg_img1"/>
            </div>
        </div>
        <div class="ol_shape18">
            <div class="animation" data-animation="fadeInRight" data-animation-delay="0.5s">
                <img data-parallax='{"y": 20, "smoothness": 20}' src="{{ asset('landing/images/testimonial_bg_img2.png') }}" alt="testimonial_bg_img2"/>
            </div>
        </div>
    </div>
</section>
