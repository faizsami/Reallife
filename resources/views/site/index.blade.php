...
<section class="banner_slider p-0">
    <div id="carouselExampleFade" class="carousel slide carousel-fade" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active bg_light_green background_bg" data-img-src="{{ asset('landing/images/slide_bg_pattern.png') }}">
                ...
                <div class="banner_shape">
                    <div class="shape1">
                    	<div class="animation" data-animation="rollIn" data-animation-delay="0.5s">
                    		<img data-parallax='{"y": -30, "smoothness": 20}' src="{{ asset('landing/images/shape1.png') }}" alt="shape1"/>
                        </div>
                    </div>
                    <div class="shape2">
                    	<div class="animation" data-animation="bounceInDown" data-animation-delay="0.5s">
                    		<img data-parallax='{"y": 30, "smoothness": 20}' src="{{ asset('landing/images/shape2.png') }}" alt="shape2"/>
                        </div>
                    </div>
                    <div class="shape3">
                    	<div class="animation" data-animation="bounceInRight" data-animation-delay="0.5s">
                    		<img data-parallax='{"y": 30, "smoothness": 20}' src="{{ asset('landing/images/shape3.png') }}" alt="shape3"/>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="banner_shape">
                    <div class="shape4">
                    	<div class="animation" data-animation="fadeInLeftBig" data-animation-delay="0.5s">
                    		<img data-parallax='{"y": -30, "smoothness": 20}' src="{{ asset('landing/images/shape4.png') }}" alt="shape4"/>
                        </div>
                    </div>
                    <div class="shape5">
                    	<div class="animation" data-animation="slideInDown" data-animation-delay="0.5s">
                    		<img data-parallax='{"y": 30, "smoothness": 20}' src="{{ asset('landing/images/shape5.png') }}" alt="shape5"/>
                        </div>
                    </div>
                    <div class="shape6">
                    	<div class="animation" data-animation="bounceInDown" data-animation-delay="0.5s">
                    		<img data-parallax='{"y": 30, "smoothness": 20}' src="{{ asset('landing/images/shape6.png') }}" alt="shape6"/>
                        </div>
                    </div>
                    <div class="shape7">
                    	<div class="animation" data-animation="fadeInRightBig" data-animation-delay="0.5s">
                    		<img data-parallax='{"y": 30, "smoothness": 20}' src="{{ asset('landing/images/shape7.png') }}" alt="shape7"/>
                        </div>
                    </div>
                    <div class="shape8">
                    	<div class="animation" data-animation="slideInUp" data-animation-delay="0.5s">
                    		<img data-parallax='{"y": 30, "smoothness": 20}' src="{{ asset('landing/images/shape8.png') }}" alt="shape8"/>
                        </div>
                    </div>
                    <div class="shape9">
                    	<div class="animation" data-animation="bounceInUp" data-animation-delay="0.5s">
                    		<img data-parallax='{"y": 30, "smoothness": 20}' src="{{ asset('landing/images/shape9.png') }}" alt="shape9"/>
                        </div>
                    </div>
                    <div class="shape10">
                    	<div class="animation" data-animation="bounceInUp" data-animation-delay="0.5s">
                    		<img data-parallax='{"y": 30, "smoothness": 20}' src="{{ asset('landing/images/shape10.png') }}" alt="shape10"/>
                        </div>
                    </div>
                    <div class="shape11">
                    	<div class="animation" data-animation="bounceInUp" data-animation-delay="0.5s">
                    		<img data-parallax='{"y": 30, "smoothness": 20}' src="{{ asset('landing/images/shape11.png') }}" alt="shape11"/>
                        </div>
                    </div>
                </div>
            </div>
            <div class="carousel-item bg_light_blue">
                ...
                <div class="banner_shape">
                    <div class="shape12">
                    	<div class="animation" data-animation="slideInDown" data-animation-delay="0.5s">
                    		<img data-parallax='{"y": -30, "smoothness": 20}' src="{{ asset('landing/images/shape12.png') }}" alt="shape12"/>
                        </div>
                    </div>
                    <div class="shape13">
                    	<div class="animation" data-animation="slideInDown" data-animation-delay="0.5s">
                    		<img data-parallax='{"y": 30, "smoothness": 20}' src="{{ asset('landing/images/shape13.png') }}" alt="shape13"/>
                        </div>
                    </div>
                    <div class="shape14">
                    	<div class="animation" data-animation="zoomIn" data-animation-delay="0.5s">
                    		<img data-parallax='{"y": 30, "smoothness": 20}' src="{{ asset('landing/images/shape14.png') }}" alt="shape14"/>
                        </div>
                    </div>
                    <div class="shape15">
                    	<div class="animation" data-animation="bounceInUp" data-animation-delay="0.5s">
                    		<img data-parallax='{"y": 30, "smoothness": 20}' src="{{ asset('landing/images/shape15.png') }}" alt="shape15"/>
                        </div>
                    </div>
                    <div class="shape16">
                    	<div class="animation" data-animation="zoomInUp" data-animation-delay="0.5s">
                    		<img data-parallax='{"y": 30, "smoothness": 20}' src="{{ asset('landing/images/shape16.png') }}" alt="shape16"/>
                        </div>
                    </div>
                    <div class="shape17">
                    	<div class="animation" data-animation="slideInLeft" data-animation-delay="0.5s">
                    		<img data-parallax='{"y": 30, "smoothness": 20}' src="{{ asset('landing/images/shape17.png') }}" alt="shape17"/>
                        </div>
                    </div>
                </div>
            </div>
    	...
    	<div class="row">
        	<div class="col-md-4 animation" data-animation="bounceInUp" data-animation-delay="0.2s">
            	<div class="banner_box box_shadow4 radius_all_10">
                    ...
                    <div class="banner_img">
                    	<img src="{{ asset('landing/images/banner_img1.png') }}" alt="banner_img1" />
                    </div>
                </div>
            </div>
            <div class="col-md-4 animation" data-animation="bounceInUp" data-animation-delay="0.3s">
            	<div class="banner_box box_shadow4 radius_all_10">
                    ...
                    <div class="banner_img">
                    	<img src="{{ asset('landing/images/banner_img2.png') }}" alt="banner_img2" />
                    </div>
                </div>
            </div>
            <div class="col-md-4 animation" data-animation="bounceInUp" data-animation-delay="0.4s">
            	<div class="banner_box box_shadow4 radius_all_10">
                    ...
                    <div class="banner_img">
                    	<img src="{{ asset('landing/images/banner_img3.png') }}" alt="banner_img3" />
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row align-items-center">
        	<div class="col-lg-4 col-md-6">
            	<div class="icon_box icon_box_style1 bg-white radius_all_10 animation" data-animation="fadeInUp" data-animation-delay="0.04s">
                	<div class="box_icon">
                		<img src="{{ asset('landing/images/icon1.png') }}" alt="icon1">
                    </div>
                ...
                <div class="icon_box icon_box_style1 bg-white radius_all_10 animation" data-animation="fadeInUp" data-animation-delay="0.05s">
                	<div class="box_icon">
                		<img src="{{ asset('landing/images/icon2.png') }}" alt="icon2">
                    </div>
                    <div class="intro_desc">
            ...
            <div class="col-lg-4 col-md-6 order-lg-last">
            	<div class="icon_box icon_box_style1 bg-white radius_all_10 animation" data-animation="fadeInUp" data-animation-delay="0.04s">
                	<div class="box_icon">
                		<img src="{{ asset('landing/images/icon3.png') }}" alt="icon3">
                    </div>
                    <div class="intro_desc">
                ...
                <div class="icon_box icon_box_style1 bg-white radius_all_10 animation" data-animation="fadeInUp" data-animation-delay="0.05s">
                	<div class="box_icon">
                		<img src="{{ asset('landing/images/icon4.png') }}" alt="icon4">
                    </div>
                    <div class="intro_desc">
            ...
            <div class="col-lg-4 col-sm-12">
                <div class="why_choose_img bounceimg">
                    <img src="{{ asset('landing/images/why_choose_img.png') }}" alt="why_choose_img">
                </div>
            </div>
        </div>
    </div>
    <div class="wave_shape"><img src="{{ asset('landing/images/wave_shape.png') }}" alt="wave_shape"></div>
    <div class="overlap_shape">
        <div class="ol_shape1">
            <div class="animation" data-animation="bounceInDown" data-animation-delay="0.5s">
                <img data-parallax='{"y": -30, "smoothness": 20}' src="{{ asset('landing/images/shape18.png') }}" alt="shape18"/>
            </div>
        </div>
        <div class="ol_shape2">
            <div class="animation" data-animation="zoomIn" data-animation-delay="0.5s">
                <img data-parallax='{"y": 30, "smoothness": 20}' src="{{ asset('landing/images/shape19.png') }}" alt="shape19"/>
            </div>
        </div>
        <div class="ol_shape3">
            <div class="animation" data-animation="zoomIn" data-animation-delay="0.5s">
                <img data-parallax='{"y": 30, "smoothness": 20}' src="{{ asset('landing/images/shape20.png') }}" alt="shape20"/>
            </div>
        </div>
        <div class="ol_shape4">
            <div class="animation" data-animation="bounceInUp" data-animation-delay="0.5s">
                <img data-parallax='{"y": 30, "smoothness": 20}' src="{{ asset('landing/images/shape21.png') }}" alt="shape21"/>
            </div>
        </div>
        <div class="ol_shape5">
            <div class="animation" data-animation="slideInRight" data-animation-delay="0.5s">
                <img data-parallax='{"y": 30, "smoothness": 20}' src="{{ asset('landing/images/shape22.png') }}" alt="shape22"/>
            </div>
        </div>
        <div class="ol_shape6">
            <div class="animation" data-animation="slideInRight" data-animation-delay="0.5s">
                <img data-parallax='{"y": 30, "smoothness": 20}' src="{{ asset('landing/images/shape23.png') }}" alt="shape23"/>
            </div>
        </div>
        <div class="ol_shape7">
            <div class="animation" data-animation="slideInRight" data-animation-delay="0.5s">
                <img data-parallax='{"y": 30, "smoothness": 20}' src="{{ asset('landing/images/shape24.png') }}" alt="shape24"/>
            </div>
        </div>
    </div>
</section>
                ...
                <div class="product_content">
                    <ul class="nav nav-tabs justify-content-center animation" data-animation="fadeInUp" data-animation-delay="0.04s" role="tablist">
                        ...
                        @foreach($categories as $category)
                            <li class="nav-item">
                                <a class="nav-link {{$i == 0 ? 'active' : ''}}" id="tab{{$i}}" data-toggle="tab" href="#tab-{{$i}}" role="tab" aria-controls="tab-{{$i}}" aria-selected="true"><span class="pr_icon1"></span>{{$category->title}}</a>
                            </li>
                            @php($i++)
                        @endforeach
                    </ul>
                    ...
                    <div class="tab-content">
                        @php($i=0)
                        @foreach($categories as $category)
                            <div class="tab-pane fade show {{$i == 0 ? 'active' : ''}}" id="tab-{{$i}}" role="tabpanel" aria-labelledby="tab{{$i}}">
                                <div class="row animation" data-animation="fadeInUp" data-animation-delay="0.05s">
                                    @php($products = $category->product()->where('status', 0)->get()->all())
    ...
    <div class="overlap_shape">
        <div class="ol_shape8">
            <div class="animation" data-animation="fadeInLeft" data-animation-delay="0.5s">
                <img data-parallax='{"y": -30, "smoothness": 20}' src="{{ asset('landing/images/shape25.png') }}" alt="shape25"/>
            </div>
        </div>
        <div class="ol_shape9">
            <div class="animation" data-animation="fadeInLeft" data-animation-delay="0.5s">
                <img data-parallax='{"y": 30, "smoothness": 20}' src="{{ asset('landing/images/shape26.png') }}" alt="shape26"/>
            </div>
        </div>
        <div class="ol_shape10">
            <div class="animation" data-animation="fadeInLeft" data-animation-delay="0.5s">
                <img data-parallax='{"y": 30, "smoothness": 20}' src="{{ asset('landing/images/shape27.png') }}" alt="shape27"/>
            </div>
        </div>
        <div class="ol_shape11">
            <div class="animation" data-animation="fadeInRight" data-animation-delay="0.5s">
                <img data-parallax='{"y": 30, "smoothness": 20}' src="{{ asset('landing/images/shape28.png') }}" alt="shape28"/>
            </div>
        </div>
        <div class="ol_shape12">
            <div class="animation" data-animation="fadeInRight" data-animation-delay="0.5s">
                <img data-parallax='{"y": 30, "smoothness": 20}' src="{{ asset('landing/images/shape29.png') }}" alt="shape29"/>
            </div>
        </div>
        <div class="ol_shape13">
            <div class="animation" data-animation="fadeInRight" data-animation-delay="0.5s">
                <img data-parallax='{"y": 30, "smoothness": 20}' src="{{ asset('landing/images/shape30.png') }}" alt="shape30"/>
            </div>
        </div>
        <div class="ol_shape14">
            <div class="bounceimg" data-animation="fadeInRight" data-animation-delay="0.5s">
                <img data-parallax='{"y": 30, "smoothness": 20}' src="{{ asset('landing/images/shape31.png') }}" alt="shape31"/>
            </div>
        </div>
    </div>
</section>
