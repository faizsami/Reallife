                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ url('/user/edit-profile') }}">Profile</a>
                                    </li>
                                ...
                                <div class="card-body">
                                    <div class="tab-content">
                                        ...
                                        <div role="tabpanel" class="tab-pane active" id="account-vertical-general" aria-labelledby="account-pill-general" aria-expanded="true">
                                            ...
                                            @endif
                                            <!-- form -->
                                            <form class="validate-form mt-2" action="{{ url('user/update-personal-details') }}" method="post" enctype="multipart/form-data">
                                                @csrf
                                                <!-- header media -->
                                                <div class="media">
                                                ...
                                                <div class="row mt-1">
                                                    ...
                                                    <div class="col-12 col-sm-6 text-center">
                                                        <button type="submit" class="btn btn-primary mt-2 mr-1" @if($is_personal) disabled @endif>Update</button>
                                                    </div>
                                                </div>
                                            </form>
                                            <!--/ form -->
                                        ...
                                        <div role="tabpanel" class="tab-pane" id="account-vertical-bank" aria-labelledby="account-pill-bank" aria-expanded="false">
                                            ...
                                            <!-- form -->
                                            <form class="validate-form mt-2" action="{{ url('user/update-bank-details') }}" method="post">
                                                @csrf
                                        ...
                                        <div role="tabpanel" class="tab-pane" id="account-vertical-kyc" aria-labelledby="account-pill-kyc" aria-expanded="false">
                                            ...
                                            @if(!$is_both_doc)
                                            <!-- form -->
                                            <form class="forms-sample" action="{{ url('/user/update-kyc-details') }}" method="post" enctype="multipart/form-data">
                                                @csrf
                                                <div class="row">
                                                    ...
                                                    <tbody>                                                        
                                                        ...
                                                        @foreach(Auth::user()->kyc as $kyc)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    @if($kyc->status != 1)
                                                                        <button class="btn btn-danger" data-toggle="tooltip" data-placement="top" title="Delete Document" onclick="window.location='{{ url('/user/kyc-details/delete/'.$kyc->id) }}'">
                                        ...
                                        <div class="tab-pane fade" id="account-vertical-password" role="tabpanel" aria-labelledby="account-pill-password" aria-expanded="false">
                                            <!-- form -->
                                            <form class="validate-form" method="post" action="{{ url('/user/change-password') }}">
                                                @csrf
                                                <div class="row">
                                                    <div class="col-12 col-sm-6">
                                                        <div class="form-group">
