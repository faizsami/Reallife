                    ...
                    <div class="col-12">
                        <div class="card p-1">
                            <div class="card-header">
                                ...
                                <a href="{{ url('/user/franchisee/create-invoice') }}" class="btn btn-primary">
                                ...
                                <tbody>
                                    ...
                                    @foreach($orders as $order)
                                        <tr>
                                            ...
                                            <td>{{ $order->user->user_name.' ('.$order->user->user_id.')' }}</td>
                                            ...
                                            <td>
                                                ...
                                                @foreach($order->items as $item)
                                                    @php($temp_amt = $item->price)
                                                    @php($amt += $temp_amt)
                                                    @php($tax += ($temp_amt * $item->tax)/100)
                                                @endforeach
                                                {{ $amt + $tax }}
                                            </td>
