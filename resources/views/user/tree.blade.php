                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <dl class="row">
                                <dt class="col-xl-4 text-left "><p class="text-success"><strong> Self BV = </strong> <span id="self_bv">20</span> </p>                               
                                    <dd class="col-xl-8 text-left"><p class="text-success"><strong> Joining Date = </strong> <span id="created_at">20</span> </p></dd>
                                <dt class="col-xl-4 text-left "><p class="text-primary"><strong> Left BV = </strong> <span id="left_bv">20</span> </p>                               
                                <dd class="col-xl-8 text-left"><p class="text-primary"><strong> Right BV = </strong> <span id="right_bv">20</span> </p></dd>
                                <dt class="col-xl-4 text-left "><p class="text-warning"><strong> Left Count = </strong> <span id="left_count">20</span> </p>                               
                                    <dd class="col-xl-8 text-left"><p class="text-warning"><strong> Right Count = </strong> <span id="right_count">20</span> </p></dd>
                            </dl>
