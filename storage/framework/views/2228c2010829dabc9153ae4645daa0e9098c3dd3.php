                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="<?php echo e(url('/user/edit-profile')); ?>">Profile</a>
                                    </li>
                                ...
                                <div class="card-body">
                                    <div class="tab-content">
                                        ...
                                        <div role="tabpanel" class="tab-pane active" id="account-vertical-general" aria-labelledby="account-pill-general" aria-expanded="true">
                                            ...
                                            <?php endif; ?>
                                            <!-- form -->
                                            <form class="validate-form mt-2" action="<?php echo e(url('user/update-personal-details')); ?>" method="post" enctype="multipart/form-data">
                                                <?php echo csrf_field(); ?>
                                                <!-- header media -->
                                                <div class="media">
                                                ...
                                                <div class="row mt-1">
                                                    ...
                                                    <div class="col-12 col-sm-6 text-center">
                                                        <button type="submit" class="btn btn-primary mt-2 mr-1" <?php if($is_personal): ?> disabled <?php endif; ?>>Update</button>
                                                    </div>
                                                </div>
                                            </form>
                                            <!--/ form -->
                                        ...
                                        <div role="tabpanel" class="tab-pane" id="account-vertical-bank" aria-labelledby="account-pill-bank" aria-expanded="false">
                                            ...
                                            <!-- form -->
                                            <form class="validate-form mt-2" action="<?php echo e(url('user/update-bank-details')); ?>" method="post">
                                                <?php echo csrf_field(); ?>
                                        ...
                                        <div role="tabpanel" class="tab-pane" id="account-vertical-kyc" aria-labelledby="account-pill-kyc" aria-expanded="false">
                                            ...
                                            <?php if(!$is_both_doc): ?>
                                            <!-- form -->
                                            <form class="forms-sample" action="<?php echo e(url('/user/update-kyc-details')); ?>" method="post" enctype="multipart/form-data">
                                                <?php echo csrf_field(); ?>
                                                <div class="row">
                                                    ...
                                                    <tbody>                                                        
                                                        ...
                                                        <?php $__currentLoopData = Auth::user()->kyc; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kyc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <?php if($kyc->status != 1): ?>
                                                                        <button class="btn btn-danger" data-toggle="tooltip" data-placement="top" title="Delete Document" onclick="window.location='<?php echo e(url('/user/kyc-details/delete/'.$kyc->id)); ?>'">
                                        ...
                                        <div class="tab-pane fade" id="account-vertical-password" role="tabpanel" aria-labelledby="account-pill-password" aria-expanded="false">
                                            <!-- form -->
                                            <form class="validate-form" method="post" action="<?php echo e(url('/user/change-password')); ?>">
                                                <?php echo csrf_field(); ?>
                                                <div class="row">
                                                    <div class="col-12 col-sm-6">
                                                        <div class="form-group">
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel Project\regallife 11march\resources\views/user/edit-profile.blade.php ENDPATH**/ ?>