...
<?php $__env->startSection('page_name', 'Fund Requests'); ?>
                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="<?php echo e(url('/admin/fund-requests')); ?>">Requests</a>
                                </li>
                                    ...
                                    <table class="table" id="fundRequestTable">
                                        ...
                                        <tbody>
                                            ...
                                            <?php $__currentLoopData = $fundrequests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fundrequest): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    <td><?php echo e($i); ?></td>
                                                    <td><?php echo e($fundrequest->created_at); ?></td>
                                                    <td><?php echo e($fundrequest->user->user_id); ?></td>
                                                    <td><?php echo e($fundrequest->user->user_name); ?></td>
                                                    <td><?php echo e($fundrequest->transaction_id); ?></td>
                                                    <td><?php echo e($fundrequest->transaction_date); ?></td>
                                                    <td><?php echo e($fundrequest->amount); ?></td>
                                                    <td>
                                                        <?php if($fundrequest->status == 0): ?>
                                                            <span class="badge badge-warning">Pending<span>
                                                        <?php elseif($fundrequest->status == 1): ?>
                                                            <span class="badge badge-success">Successed<span>
                                                        <?php elseif($fundrequest->status == 2): ?>
                                                            <span class="badge badge-danger">Failed<span>
                                                        <?php endif; ?>
                                                    </td>
                                                    <td>
                                                        <?php if($fundrequest->status != 1): ?>
                                                            <div class="btn-group">
                                                                <a class="dropdown-toggle hide-arrow" data-toggle="dropdown">                                                                
                                                                    <i data-feather='more-vertical'></i>
                                                                </a>
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    <a href="#" class="dropdown-item" data-toggle="modal" data-target="#sendMoneyModel" onclick="event.preventDefault(); callacceptmodal('<?php echo e(url('admin/accept-fund-request/'.$fundrequest->id)); ?>', '<?php echo e($fundrequest->transaction_id); ?>', '<?php echo e($fundrequest->transaction_date); ?>', '<?php echo e($fundrequest->amount); ?>')">
                                                                        <i data-feather='check-square'></i>
                                                                        Accept
                                                                    </a>                                                                

                                                                    <a href="<?php echo e(url('/admin/decline-fund-request/'.$fundrequest->id)); ?>" class="dropdown-item">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel Project\regallife 11march\resources\views/admin/fund-requests.blade.php ENDPATH**/ ?>