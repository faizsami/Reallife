...
<body class="vertical-layout vertical-menu-modern navbar-floating footer-static menu-collapsed <?php echo e(Auth::user()->theme->setting == 1 ? 'dark-layout' : ''); ?>" data-open="click" data-menu="vertical-menu-modern" data-col="">
            ...
            <ul class="nav navbar-nav align-items-center ml-auto">
                ...
                <li class="nav-item dropdown dropdown-cart mr-25">
                    <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="user-nav d-sm-flex d-none">
                            <span class="user-name font-weight-bolder">Wallet Balance: ₹<?php echo e(number_format(Auth::user()->wallet->balance,2)); ?></span>
                        </div>
                    </a>                    
                </li>
                <li class="nav-item d-lg-block"><a class="nav-link" href="<?php echo e(url('/user/change-theme-dark')); ?>"><i class="ficon" data-feather="<?php echo e(Auth::user()->theme->setting == 1 ? 'sun' : 'moon'); ?>"></i></a></li>                
                <li class="nav-item dropdown dropdown-cart mr-25"><a class="nav-link" href="javascript:void(0);" data-toggle="dropdown"><i class="ficon" data-feather="shopping-cart"></i><span class="badge badge-pill badge-primary badge-up cart-item-count"><?php echo e(count($carts)); ?></span></a>
                    <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">                        
                        <li class="dropdown-menu-header">
                            <div class="dropdown-header d-flex">
                                <h4 class="notification-title mb-0 mr-auto">My Cart</h4>
                                <div class="badge badge-pill badge-light-primary"><?php echo e(count($carts)); ?> Items</div>
                            </div>
                        </li>
                        <li class="scrollable-container media-list">
                            <?php ($total_price = 0); ?>                         
                            <?php $__currentLoopData = $carts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cart): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="media align-items-center"><img class="d-block rounded mr-1" src="<?php echo e(asset('uploads/products/'.$cart->product->image)); ?>" alt="donuts" width="62">
                                    <div class="media-body"><i class="ficon cart-item-remove" data-feather="x" onclick="window.location='<?php echo e(url('/user/delete-from-cart/'.$cart->id)); ?>'"></i>
                                        <div class="media-heading">
                                            <h6 class="cart-item-title"><a class="text-body" href=""> <?php echo e($cart->product->name); ?></a></h6><small class="cart-item-by"></small>
                                        </div>
                                        <div class="cart-item-qty">
                                            <div class="">
                                                <form action="<?php echo e(url('user/cart-stock-add')); ?>" method="post" id="formcartstockheader<?php echo e($cart->id); ?>">
                                                    <?php echo csrf_field(); ?>
                                                    <input type="hidden" value="<?php echo e($cart->id); ?>" name="id" hidden/>
                                                    <input type="number" onchange="$('#formcartstockheader<?php echo e($cart->id); ?>').submit()" class="form-control w-50 border-0 shadow ml-2" name="stock" value="<?php echo e($cart->qty); ?>" />
                                                </form>
                                            </div>
                                        </div>
                        ...
                        <li class="dropdown-menu-footer">
                            <div class="d-flex justify-content-between mb-1">
                                ...
                                <h6 class="text-primary font-weight-bolder mb-0">₹ <?php echo e(number_format($total_price,2)); ?></h6>
                            </div><a class="btn btn-primary btn-block" href="<?php echo e(url('/user/cart/')); ?>">Checkout</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="nav-item dropdown dropdown-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown-user">
						...
						<a class="dropdown-item" href="<?php echo e(url('/user/wallet')); ?>">
							<i class="mr-50" data-feather="credit-card"></i> 
							Wallet
                        </a>
                        <a class="dropdown-item" href="<?php echo e(url('/user/edit-profile')); ?>">
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item mr-auto"><a class="navbar-brand" href="<?php echo e(url('/user/dashboard')); ?>"><span class="brand-logo">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
				<li class="<?php echo e($active == 'dashboard' ? 'active' : ''); ?> nav-item">
					<a class="d-flex align-items-center" href="<?php echo e(url('/user/dashboard')); ?>">
				...
				<li class="<?php echo e($active[0] == 'profile' ? 'has-sub sidebar-group-active menu-collapsed-open' : ''); ?> nav-item">
                    ...
                    <ul class="menu-content">
						<li class="<?php echo e($active[1] == 'profile' ? 'active' : ''); ?>">
							<a class="d-flex align-items-center" href="<?php echo e(url('/user/profile')); ?>">
						...
						<li class="<?php echo e($active[1] == 'wallet' ? 'active' : ''); ?>">
							<a class="d-flex align-items-center" href="<?php echo e(url('/user/wallet')); ?>">
								<i data-feather="circle"></i>
						...
						<li class="<?php echo e($active[1] == 'edit' ? 'active' : ''); ?>">
							<a class="d-flex align-items-center" href="<?php echo e(url('/user/edit-profile')); ?>">
								<i data-feather="circle"></i>
								<span class="menu-item" data-i18n="Edit">Edit Profile</span>
							</a>
                        </li>
                        
                        <li class="<?php echo e($active[1] == 'welcome' ? 'active' : ''); ?>">
							<a class="d-flex align-items-center" href="<?php echo e(url('/user/welcome-letter')); ?>">
								<i data-feather="circle"></i>
                ...
                <li class="<?php echo e($active == 'withdrawal' ? 'active' : ''); ?> nav-item">
					<a class="d-flex align-items-center" href="<?php echo e(url('/user/withdraw')); ?>">
				...
				<li class="<?php echo e($active[0] == 'shopping' ? 'has-sub sidebar-group-active menu-collapsed-open' : ''); ?> nav-item">
                    ...
                    <ul class="menu-content">
						<li class="<?php echo e($active[1] == 'products' ? 'active' : ''); ?>">
							<a class="d-flex align-items-center" href="<?php echo e(url('/user/products')); ?>">
								<i data-feather="circle"></i>
								<span class="menu-item" data-i18n="Edit">Products</span>
							</a>
						</li>

						<li class="<?php echo e($active[1] == 'cart' ? 'active' : ''); ?>">
							<a class="d-flex align-items-center" href="<?php echo e(url('/user/cart')); ?>">
								<i data-feather="circle"></i>
						...
						<li class="<?php echo e($active[1] == 'orders' ? 'active' : ''); ?>">
							<a class="d-flex align-items-center" href="<?php echo e(url('/user/orders')); ?>">
								<i data-feather="circle"></i>
				...
				<li class="<?php echo e($active[0] == 'teamview' ? 'has-sub sidebar-group-active menu-collapsed-open' : ''); ?> nav-item">
                    ...
                    <ul class="menu-content">
                        <li class="<?php echo e($active[1] == 'teamview' ? 'active' : ''); ?>">
							<a class="d-flex align-items-center" href="<?php echo e(url('/user/tree')); ?>">
								<i data-feather="circle"></i>
								<span class="menu-item" data-i18n="List">My TreeView</span>
							</a>
                        </li>
                        <li class="<?php echo e($active[1] == 'direct' ? 'active' : ''); ?>">
							<a class="d-flex align-items-center" href="<?php echo e(url('/user/my-direct')); ?>">
								<i data-feather="circle"></i>
                ...
                <li class="<?php echo e($active == 'registration' ? 'active' : ''); ?> nav-item">
					<a class="d-flex align-items-center" href="<?php echo e(url('/user/registration')); ?>">
                ...
                <li class="nav-item">
                    ...
                    <ul class="menu-content">
                        <li class="<?php echo e($active == 'bv_report' ? 'active' : ''); ?>">
                            <a class="d-flex align-items-center" href="<?php echo e(url('/user/bv-report')); ?>">
                                <i data-feather="circle"></i>
                                <span class="menu-item" data-i18n="List">B.V Report</span>
                            </a>
                        </li>
                        <li class="<?php echo e($active == 'my_gen_bonus_report' ? 'active' : ''); ?>">
                            <a class="d-flex align-items-center" href="<?php echo e(url('/user/genbonus')); ?>">
                                <i data-feather="circle"></i>
                                <span class="menu-item" data-i18n="List">My Gen Per Bonus</span>
                            </a>
                        </li>
                        <li class="<?php echo e($active == 'monthly_incentive' ? 'active' : ''); ?>">
                            <a class="d-flex align-items-center" href="<?php echo e(url('/user/monthly-incentive')); ?>">
                                <i data-feather="circle"></i>
                ...
                <?php if(Auth::user()->is_partner == 0): ?>
                    <li class="<?php echo e($active == 'franchisee' ? 'active' : ''); ?> nav-item">
                        <a class="d-flex align-items-center" href="<?php echo e(url('/user/franchisee/requests')); ?>">
                ...
                <?php else: ?>
                    <li class="<?php echo e($active[0] == 'franchisee' ? 'has-sub sidebar-group-active menu-collapsed-open' : ''); ?> nav-item">
                        ...
                        <ul class="menu-content">
                            <li class="<?php echo e($active[1] == 'franchisee-bill' ? 'active' : ''); ?>">
                                <a class="d-flex align-items-center" href="<?php echo e(url('/user/franchisee/invoices')); ?>">
                                    <i data-feather="circle"></i>
                                    <span class="menu-item" data-i18n="List">Invoices</span>
                                </a>
                            </li>

                            <li class="<?php echo e($active[1] == 'franchisee-order' ? 'active' : ''); ?>">
                                <a class="d-flex align-items-center" href="<?php echo e(url('/user/franchisee/order')); ?>">
                                    <i data-feather="circle"></i>
                                    <span class="menu-item" data-i18n="View">Order</span>
                                </a>
                            </li>

                            <li class="<?php echo e($active[1] == 'franchisee-stock' ? 'active' : ''); ?>">
                                <a class="d-flex align-items-center" href="<?php echo e(url('/user/franchisee/stocks')); ?>">
                                    <i data-feather="circle"></i>
                                    <span class="menu-item" data-i18n="View">Stocks</span>
                                </a>
                            </li>

                            <li class="<?php echo e($active[1] == 'franchisee-wallet' ? 'active' : ''); ?>">
                                <a class="d-flex align-items-center" href="<?php echo e(url('/user/franchisee/wallet')); ?>">
                                    <i data-feather="circle"></i>
    ...
    <a data-toggle="tooltip" onclick="event.preventDefault();" id="copytoclipboardId" data-placement="top" title="" data-original-title="Share referral link" <?php echo e(Auth::user()->theme->setting == 1 ? 'style=background-color:#161d31;' : ''); ?> href="#" class="float <?php echo e(Auth::user()->theme->setting == 1 ? '' : 'bg-gradient-primary'); ?>" target="_blank">
        <input type="text" id="hiddenClipboard" style="display: none" value="<?php echo e(url('/register?id='.Auth::user()->user_id)); ?>"/>
    ...
    <!-- END: Page JS-->
    <script src="<?php echo e(asset('assets/js/scripts/extensions/ext-component-clipboard.js')); ?>"></script>
    <script>
...
</html><?php /**PATH D:\Laravel Project\regallife 11march\resources\views/layouts/user.blade.php ENDPATH**/ ?>