...
<?php $__env->startSection('page_name', 'Wallet'); ?>
...
<!-- END: Vendor CSS-->
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                ...
                <div class="col-md-3 col-12">
                    <a href="<?php echo e(url('/user/request-fund')); ?>" data-toggle="tolltips" title="Request Money" class="btn btn-icon btn-primary mt-1 float-right" ><i data-feather='plus'></i> Request Money</a>
                </div>
            </div><br>
                        ...
                        <div class="col-lg-3 col-sm-6 col-12">
                            <div class="card">
                                <div class="card-header flex-column align-items-start pb-0">
                                    ...
                                    <h2 class="font-weight-bolder mt-1">₹ <?php echo e(number_format($balance, 2)); ?></h2>
                        ...
                        <div class="col-lg-3 col-sm-6 col-12">
                            <div class="card">
                                <div class="card-header flex-column align-items-start pb-0">
                                    ...
                                    <h2 class="font-weight-bolder mt-1">₹ <?php echo e(number_format($creditedBalance, 2)); ?></h2>
                        ...
                        <div class="col-lg-3 col-sm-6 col-12">
                            <div class="card">
                                <div class="card-header flex-column align-items-start pb-0">
                                    ...
                                    <h2 class="font-weight-bolder mt-1">₹ <?php echo e(number_format($debitedBalance, 2)); ?></h2>
                        ...
                        <div class="col-lg-3 col-sm-6 col-12">
                            <div class="card">
                                <div class="card-header flex-column align-items-start pb-0">
                                    ...
                                    <h2 class="font-weight-bolder mt-1">₹ <?php echo e(number_format($reward, 2)); ?></h2>
    ...
    <div class="modal fade text-left" id="sendMoneyModel" tabindex="-1" aria-labelledby="sendMoneyModel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <form method="post" action="<?php echo e(url('/user/send-money')); ?>">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel Project\regallife 11march\resources\views/user/wallet.blade.php ENDPATH**/ ?>