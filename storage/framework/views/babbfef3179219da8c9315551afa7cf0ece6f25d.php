...
<?php $__env->startSection('page_name', 'Pending Kycs'); ?>
                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="<?php echo e(url('/admin/members')); ?>">Members</a>
                                </li>
                        ...
                        <div class="card p-1">
                            ...
                            <div class="table-responsive">
                                <table class="table" id="orderTabledata">
                                    ...
                                    <tbody>
                                        <?php ($i=count($lists)); ?>
                                        <?php $__currentLoopData = $lists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $request): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td><?php echo e($i); ?></td>
                                                <td>
                                                ...
                                                <td><?php echo e($request->document_number); ?></td>
                                                <td>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">                                                                            
                                                            <a href="<?php echo e(url('/admin/member/kyc/'.$request->id.'/1')); ?>" class="dropdown-item">
                                                                <i data-feather='eye'></i>
                                                                Apporve
                                                            </a>

                                                            <a href="<?php echo e(url('/admin/member/kyc/'.$request->id.'/2')); ?>" class="dropdown-item">
                                                                <i data-feather='eye'></i>
                                                                Decline
                                                            </a>
                                                        </div>
...
<script>
    function callOrderItemViewer(order_id)
    {
        ...
        var url = '<?php echo e(asset('uploads/products')); ?>';
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel Project\regallife 11march\resources\views/admin/pending-kyc.blade.php ENDPATH**/ ?>