                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="<?php echo e(url('/admin/tree')); ?>">TreeView</a>
                                </li>
                                    ...
                                    <table class="table" id="membersDataTable">
                                        ...
                                        <tbody><?php ($i=count($users)); ?>
                                            <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if($user->sponser_id != '0'): ?>
                                                    <tr>
                                                        <td><?php echo e($i); ?></td>
                                                        <td>
                                                            <div class="d-flex justify-content-left align-items-center">
                                                                <div class="avatar  mr-1">
                                                                    <img src="<?php echo e(asset('/uploads/profiles/'.$user->personal->profile_image)); ?>" alt="Avatar" width="32" height="32">
                                                                </div>
                                                                <div class="d-flex flex-column">
                                                                    <span class="emp_name text-truncate font-weight-bold"><?php echo e($user->user_name); ?></span>
                                                                    <small class="emp_post text-truncate text-muted"><?php echo e($user->user_id); ?></small>
                                                                    <small class="emp_post text-truncate text-muted">Joined: <?php echo e(date('d M y', strtotime($user->created_at))); ?></small>
                                                                </div>
                                                            </div>                                                        
                                                        </td>
                                                        <td>
                                                            <div class="d-flex justify-content-left align-items-center">
                                                                ...
                                                                <div class="d-flex flex-column">
                                                                    <span class="emp_name text-truncate font-weight-bold"><?php echo e($sponser->user_name); ?></span>
                                                                    <small class="emp_post text-truncate text-muted"><?php echo e($sponser->user_id); ?></small>
                                                                    <small class="emp_post text-truncate text-muted">Joined: <?php echo e(date('d M y', strtotime($sponser->created_at))); ?></small>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="d-flex justify-content-left align-items-center">
                                                                <div class="d-flex flex-column">
                                                                    <span class="emp_name text-truncate font-weight-bold"><?php echo e($user->email); ?></span>
                                                                    <small class="emp_post text-truncate text-muted"><?php echo e($user->user_mobile); ?>, <?php echo e($user->personal->alternate_mobile); ?></small>
                                                                </div>
                                                            </div>                                                        
                                                        </td>
                                                        <td>
                                                            <div class="d-flex justify-content-left align-items-center">
                                                                <div class="d-flex flex-column">
                                                                    <small class="emp_name text-truncate font-weight-bold">LEFT: <?php echo e($user->binary->left_count); ?></small>
                                                                    <small class="emp_post text-truncate font-weight-bold">RIGHT: <?php echo e($user->binary->right_count); ?></small>
                                                                </div>
                                                            </div>                                                        
                                                        </td>
                                                        <td>
                                                            <div class="d-flex justify-content-left align-items-center">
                                                                <div class="d-flex flex-column">
                                                                    <small class="emp_name text-truncate font-weight-bold">LEFT: <?php echo e($user->binary->left_bv); ?></small>
                                                                    <small class="emp_post text-truncate font-weight-bold">RIGHT: <?php echo e($user->binary->right_bv); ?></small>
                                                                    <small class="emp_post text-truncate font-weight-bold">SELF: <?php echo e($user->binary->self_bv); ?></small>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="btn-group">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    <a href="<?php echo e(url('/admin/member/'.$user->id.'/view')); ?>" class="dropdown-item">
                                                                        <i data-feather='edit'></i>
                                                                        View
                                                                    </a>

                                                                    <a href="<?php echo e(url('/admin/tree?id='.$user->user_id)); ?>" class="dropdown-item">
                                                                        <i data-feather='users'></i>
                                                                        Team View
                                                                    </a>

                                                                    <a href="<?php echo e(url('/admin/directs?id='.$user->user_id)); ?>" class="dropdown-item">
                                                                        <i data-feather='git-pull-request'></i>
                                                                        Direct View
                                                                    </a>

                                                                    <?php if($user->is_block == 0): ?>
                                                                        <a href="<?php echo e(url('/admin/member/status/'.$user->id.'/1')); ?>" class="dropdown-item text-danger">
                                                                            <i data-feather='eye-off'></i>
                                                                            Block
                                                                        </a>
                                                                    <?php else: ?>
                                                                        <a href="<?php echo e(url('/admin/member/status/'.$user->id.'/0')); ?>" class="dropdown-item text-success">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel Project\regallife 11march\resources\views/admin/users.blade.php ENDPATH**/ ?>