...
<?php $__env->startSection('page_name', 'My Tree'); ?>
                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="<?php echo e(url('/admin/tree')); ?>">TeamView</a>
                                </li>
                    ...
                    <div class="row "style="min-width:1180px!important">
                        <?php for($d=0;$d<$divide;$d++): ?>
                            <div class="col text-center">
                                <?php if($id[$d]=='0' or $id[$d]=='2'): ?>  
                                    <?php if($parent_id[$d][0] =='0' or $parent_id[$d][0] =='2'): ?>                         
                                        <img src="<?php echo e(asset('assets/images/Asset3.png')); ?>" class="image-fluid rounded-circle" style="width:50px;cursor:pointer;" >
                                        ...
                                        <?php endif; ?>
                                    <?php else: ?>
                                        <img src="<?php echo e(asset('assets/images/Asset3.png')); ?>" class="image-fluid rounded-circle" style="width:50px;cursor:pointer;" onclick="window.location='registration?id=<?php echo e($parent_id[$d][0]); ?>&position=<?php echo e($parent_id[$d][1]); ?>'">
                                ...
                                <?php else: ?>
                                    ...
                                    <?php if($sbv<500): ?>
                                        <img src="<?php echo e(asset('assets/images/Asset1.png')); ?>" class="image-fluid rounded-circle" style="width:50px;cursor:pointer;" onclick="getUserDetails('<?php echo e($id[$d]); ?>')" data-toggle="modal" data-target="#dark"  title="View Details">
                                    <?php else: ?>
                                        <img src="<?php echo e(asset('assets/images/Asset2.png')); ?>" class="image-fluid rounded-circle" style="width:50px;cursor:pointer;" onclick="getUserDetails('<?php echo e($id[$d]); ?>')" data-toggle="modal" data-target="#dark"  title="View Details">
                                    <?php endif; ?>
                                    <br>
                                    <a href="?id=<?php echo e($id[$d]); ?>"  data-toggle="tooltip" data-placement="bottom" title="View Teamview"><?php echo e($id[$d]); ?></a><br>
                                
                                    <?php echo e(App\Models\User::where('user_id', $id[$d])->exists() == true ? App\Models\User::where('user_id', $id[$d])->get()->first()->user_name : ''); ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel Project\regallife 11march\resources\views/admin/tree.blade.php ENDPATH**/ ?>