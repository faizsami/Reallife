...
Regal Life India
                        ...
                        <div class="d-none d-lg-flex col-lg-6 align-items-center p-5">
                            <div class="w-100 d-lg-flex align-items-center justify-content-center px-5"><img class="img-fluid" src="<?php echo e(asset('assets/images/pages/register-v2.svg')); ?>" alt="Register V2" /></div>
                        </div>
                        <!-- /Left Text-->
                        <!-- Register-->
                        <div class="d-flex col-lg-6 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                ...
                                <form class="auth-register-form mt-2" action="<?php echo e(url('/user-registration')); ?>" method="POST" id="registration-from">
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="form-group col-lg-6 col-md-6">
                                      ...
                                      <input type="text" class="form-control" onkeypress=" return isAlphaNumericKey(event)" onchange="getName()" value="<?php echo e($id); ?>" id="ref_id" name="refferal_id" autocomplete="false" placeholder="Enter Refferal Id" tabindex="2"  <?php echo e($auto == 0 ? 'autofocus' : 'readonly'); ?> required/>
                                      <?php if($errors->has('refferal_id')): ?>
                                        <p class="invalid-feedback text-danger" style="display:block!important;" role="alert">
                                          <strong><?php echo e($errors->first('refferal_id')); ?></strong>
                                        </p>
                                      <?php endif; ?>
                                    </div>
                                    ...
                                    <div class="form-group col-lg-6 col-md-6">
                                      ...
                                      <input type="text" class="form-control" id="ref_provider" name="ref_provider" value="<?php echo e($name_user); ?>" autocomplete="off" placeholder="Refferal Provide" readonly>
                                    </div>
                                  </div>

                                    <div class="form-group">
                                        <label class="form-label" for="register-username">Full Name</label>
                                        <input class="form-control" id="full_name" type="text" maxlength="50" onkeyup="clearmultispace($(this).val(), $(this).attr('id'))" onkeypress="return isAlphaKey(event)" name="name" placeholder="Enter Full Name" tabindex="2" <?php echo e($auto == 1 ? 'autofocus' : ''); ?> required/>
                                        ...
                                        <div class="input-group input-group-merge form-password-toggle">
                                            <select class="form-control" name="country_code">
                                              ...
                                              <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e('+'.$country->phonecode); ?>" <?php echo e($country->phonecode == 91 ? 'selected' : ''); ?>><?php echo e('(+'.$country->phonecode.')'.$country->name); ?></option>
                                    ...
                                    <div class="row">
                                      <div class="col-lg-4 col-md-4">
                                        ...
                                        <div class="form-check form-check-flat form-check-primary">                            
                                          ...
                                          <?php if($errors->has('assign_customer')): ?>
                                            <p class="invalid-feedback text-danger" style="display:block!important;" role="alert">
                                              <strong><?php echo e($errors->first('assign_customer')); ?></strong>
                                            </p>
                                          <?php endif; ?>
                                      </div>
                                ...
                                <p class="text-center mt-2"><span>Already have an account?</span><a href="<?php echo e(route('login')); ?>"><span>&nbsp;Sign in instead</span></a></p>
    ...
    <!-- BEGIN: Page JS-->
    <script src="<?php echo e(asset('assets/js/scripts/pages/page-auth-register.js')); ?>"></script>
    <!-- END: Page JS-->
...
</html><?php /**PATH D:\Laravel Project\regallife 11march\resources\views/auth/register.blade.php ENDPATH**/ ?>