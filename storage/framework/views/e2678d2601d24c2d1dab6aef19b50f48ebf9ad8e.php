                ...
                <div class="d-flex align-items-center auth-bg px-2 p-lg-5 mx-auto">
                  <div class="row">
                      <div class="col-12 px-xl-2 border border-primary p-2">
                          ...
                          <?php echo csrf_field(); ?>
                          <input type="hidden" value="<?php echo e($id); ?>" name="pid" hidden />
                          <input type="hidden" value="<?php echo e($id); ?>" name="placement_id" hidden/>
                          <div class="row">
                              <div class="form-group col-lg-6 col-md-6">
                              <label for="exampleInputUsername1">Refferal Id</label>
                              <input value="<?php echo e(Auth::user()->user_id); ?>" type="text" class="form-control" onkeypress=" return isAlphaNumericKey(event)" onchange="getName()" id="ref_id" name="refferal_id" autocomplete="false" placeholder="Enter Refferal Id" tabindex="2"  required readonly/>
                              ...
                              <input value="<?php echo e(Auth::user()->user_name); ?>" type="text" class="form-control" id="ref_provider" name="ref_provider" autocomplete="off" placeholder="Refferal Provide" readonly>
                              </div>
                          </div>
                              ...
                              <div class="col-lg-4 col-md-4 col-12">
                                  ...
                                  <label class="form-check-label">
                                      <input type="radio" class="form-check-input" value="0" name="assign_customer" tabindex="5" <?php echo e($position == 0 ? 'checked' : ''); ?> required>
                                      Left
                                  </label>                     
                                  </div>
                                  ...
                                  <div class="form-check form-check-flat form-check-primary">                            
                                  <label class="form-check-label">
                                      <input type="radio" class="form-check-input" value="1" name="assign_customer" tabindex="5" <?php echo e($position == 1 ? 'checked' : ''); ?> required/>
                                      Right
                                  </label>                     
                                  </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel Project\regallife 11march\resources\views/admin/registration.blade.php ENDPATH**/ ?>