...
<head>
    ...
    <title>Regal Life India- Page Not Found</title>
                ...
                <div class="misc-wrapper"><a class="brand-logo" href="javascript:void(0);">
                    ...
                    <div class="misc-inner p-2 p-sm-3">
                        <div class="w-100 text-center">
                            <h2 class="mb-1">Internal server error 🕵🏻‍♀️</h2>
                            <p class="mb-2">Oops! 😖 There wan an error. Please try agin later.</p><a class="btn btn-primary mb-2 btn-sm-block" href="<?php echo e(url('/')); ?>">Back to home</a><img class="img-fluid" src="<?php echo e(asset('assets/images/pages/error.svg')); ?>" alt="Error page" />
                        </div>
                    </div>
                </div>
                <!-- / Error page-->
...
</html><?php /**PATH E:\Laravel\Reallife\resources\views/errors/500.blade.php ENDPATH**/ ?>